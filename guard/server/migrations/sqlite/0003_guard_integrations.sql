...
CREATE INDEX IF NOT EXISTS idx_guard_integration_credential_app
...
CREATE TABLE IF NOT EXISTS guard_integration_http (
  ...
  private_network_allowlist TEXT NOT NULL DEFAULT '[]',
...
CREATE TABLE IF NOT EXISTS guard_integration_mqtt (
  ...
  command_topic TEXT NOT NULL UNIQUE,
  result_topic TEXT NOT NULL UNIQUE,
...
CREATE INDEX IF NOT EXISTS idx_guard_integration_mapping_source
...
CREATE INDEX IF NOT EXISTS idx_guard_integration_audit_created
...
CREATE INDEX IF NOT EXISTS idx_guard_integration_delivery_expires
...
CREATE INDEX IF NOT EXISTS idx_guard_outbox_integration_state
