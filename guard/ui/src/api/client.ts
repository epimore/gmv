...
export interface NodeInfo { node_id: string; instance_id: string; kind: string; connection: string; health: string; scheduling: string; capabilities: string[]; capacity: number; pending_leases: number; host_metrics: HostMetricsInfo; business_metrics: Record<string, string>; zone: string | null; last_seen_at_ms: number; generation: number; sequence: number }
