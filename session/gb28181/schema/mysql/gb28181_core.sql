...
CREATE TABLE IF NOT EXISTS `gb28181_device`  (
  ...
  `registration_call_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '当前REGISTER排序Call-ID',
  `registration_cseq` bigint NULL DEFAULT NULL COMMENT '当前REGISTER排序CSeq',
  `registration_epoch_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '设备连续在线业务代次',
  `registration_epoch_closed_at` datetime(3) NULL DEFAULT NULL COMMENT '当前设备业务代次关闭时间',
...
CREATE TABLE IF NOT EXISTS `gb28181_sip_dialog_session`  (
  ...
  `requested_stream_profile` varchar(16) DEFAULT NULL COMMENT 'MAIN/SUB，仅实时点播',
  `effective_stream_profile` varchar(16) DEFAULT NULL COMMENT 'MAIN/SUB，仅实时点播',
  `stream_profile_verification` varchar(16) DEFAULT NULL COMMENT 'CONFIRMED/UNVERIFIED',
  ...
  `registration_epoch_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
