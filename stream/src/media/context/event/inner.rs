...
impl InnerEvent {
    pub fn handle_event(self, media_context: &MediaContext) {
        match self {
            InnerEvent::FlvHeader(sender) => match &media_context.muxer_context.flv {
                None => {
            ...
            InnerEvent::Mp4Header(sender) => match &media_context.muxer_context.mp4 {
                None => {
            ...
            InnerEvent::Fmp4Header(sender) => match &media_context.muxer_context.fmp4 {
                None => {
            ...
            InnerEvent::DashMp4Header(sender) => match &media_context.muxer_context.dash_mp4 {
                None => {
